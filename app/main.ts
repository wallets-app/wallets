...
import * as beakerProtocol from './bg/protocols/wallets'
...
if (getEnvVar('WALLETS_USER_DATA_PATH')) {
  ...
  app.setPath('userData', getEnvVar('WALLETS_USER_DATA_PATH'))
}
...
app.on('ready', async function () {
  ...
  await logger.setup(join(commonOpts.userDataPath, 'wallets.log'))
