/* globals beaker */
import { html, css } from 'wallets://app-stdlib/vendor/lit-element/lit-element.js'
import { repeat } from 'wallets://app-stdlib/vendor/lit-element/lit-html/directives/repeat.js'
import { BasePopup } from 'wallets://app-stdlib/js/com/popups/base.js'
import buttonsCSS from 'wallets://app-stdlib/css/buttons2.css.js'
import popupsCSS from 'wallets://app-stdlib/css/com/popups.css.js'
...
import { toNiceUrl, normalizeUrl } from 'wallets://app-stdlib/js/strings.js'
...
export class AddLinkPopup extends BasePopup {
  ...
  onContextMenuHistory (e) {
    ...
    contextMenu.create({x: e.clientX, y: e.clientY, items, fontAwesomeCSSUrl: 'wallets://assets/font-awesome.css'})
  }
}
