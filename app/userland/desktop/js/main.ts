import { LitElement, html } from 'wallets://app-stdlib/vendor/lit-element/lit-element.js'
import { repeat } from 'wallets://app-stdlib/vendor/lit-element/lit-html/directives/repeat.js'
import { EditBookmarkPopup } from 'wallets://app-stdlib/js/com/popups/edit-bookmark.js'
import { AddLinkPopup } from './com/add-link-popup.js'
import * as toast from 'wallets://app-stdlib/js/com/toast.js'
import { writeToClipboard } from 'wallets://app-stdlib/js/clipboard.js'
import { pluralize } from 'wallets://app-stdlib/js/strings.js'
import * as desktop from './lib/desktop.js'
import * as addressBook from './lib/address-book.js'
import css from '../css/main.css.js'
import 'wallets://app-stdlib/js/com/img-fallbacks.js'
...
class DesktopApp extends LitElement {
  ...
  render () {
    ...
    return html`
      ...
      <div id="topright">
        ...
        <a href="wallets://library/" title="Library">My Library</a>
    ...
    return html`
      <div class="release-notice">
        <a href=${RELEASE.url} class="view-release-notes" target="_blank">
          ...
          <strong>Welcome to Wallets ${RELEASE.label}!</strong>
  ...
  async onClickNewHyperdrive (e) {
    ...
    beaker.browser.openUrl(drive.url, {setActive: true, addedPaneUrls: ['wallets://editor/']})
  }
