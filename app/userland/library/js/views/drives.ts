...
import { classMap } from 'wallets://app-stdlib/vendor/lit-element/lit-html/directives/class-map.js'
...
const EXPLORER_URL = drive => `wallets://explorer/${drive.url.slice('hyper://'.length)}`
...
export class DrivesView extends LitElement {
  ...
  async diffDrive (drive) {
    window.open(`wallets://diff/?base=${drive.url}`)
  }
