import { LitElement, html, TemplateResult } from 'wallets://app-stdlib/vendor/lit-element/lit-element.js'
...
import { joinPath, shortenAllKeys } from 'wallets://app-stdlib/js/strings.js'
...
class WebTerm extends LitElement {
  ...
  constructor () {
    ...
    ;(async () => {
      ...
      if (ctx && ctx.startsWith('wallets://webterm')) ctx = undefined
