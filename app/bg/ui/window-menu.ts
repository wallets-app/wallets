    ...
    submenu: [
      {
        ...
        accelerator: 'Cmd+,',
        click (item) {
          if (win) tabManager.create(win, 'wallets://settings', {setActive: true})
  ...
  var driveMenu = {
    ...
    submenu: [
      ...
      },
      {
        ...
        enabled: !!isDriveSite,
        async click (item) {
          if (win) tabManager.create(win, `wallets://diff/?base=${url}`, {setActive: true})
        }
      },
      { type: 'separator' },
      {
  ...
  var historyMenu = {
    ...
    submenu: [
      ...
      },
      {
        ...
        click: function (item) {
          if (win) tabManager.create(win, 'wallets://history', {setActive: true})
    ...
    submenu: [
      {
        ...
        accelerator: 'F1',
        click: function (item) {
          if (win) tabManager.create(win, 'https://docs.walllets.app', {setActive: true})
        }
      },
      {type: 'separator'},
      {
        ...
        label: 'Report Issue',
        click: function (item) {
          if (win) tabManager.create(win, 'https://github.com/walletsbrowser/wallets/issues', {setActive: true})
        }
      },
      {
        ...
        click: function (item) {
          if (win) tabManager.create(win, 'https://github.com/walletsbrowser/wallets/discussions', {setActive: true})
        }
      }
    ]
  }
